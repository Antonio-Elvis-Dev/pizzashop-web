...
export function StoreProfileDialog() {
  ...
  async function handleUpdateProfile(data: StoreProfileSchema) {
    try {
      ...
      toast.error('Falha ao atualizar o perfl, tente novamente.')
    }
  }
  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          Atualize as informaçôes do seu estabelecimento vesíveis ao seu cliente
        </DialogDescription>
      </DialogHeader>
